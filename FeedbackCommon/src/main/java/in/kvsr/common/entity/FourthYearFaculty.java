...
@Entity
@Table(name = "fourth_year_faculty")
public class FourthYearFaculty {
	@Id
	...
	public FourthYearFaculty() {
		
	}
	
	public FourthYearFaculty(String regId) {
		this.regId = regId;
	}
	...
	public String toString() {
		return "FourthYearFaculty [regId=" + regId + ", firstName=" + firstName + ", average=" + average + ", cse="
