...
@Entity
@Table(name = "third_year_faculty")
public class ThirdYearFaculty {
	@Id
	...
	public ThirdYearFaculty() {
		
	}

	public ThirdYearFaculty(String regId) {
		this.regId = regId;
	}
	...
	public String toString() {
		return "ThirdYearFaculty [regId=" + regId + ", firstName=" + firstName + ", average=" + average + ", cse=" + cse
