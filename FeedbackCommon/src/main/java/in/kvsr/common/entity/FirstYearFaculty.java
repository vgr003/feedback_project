...
@Entity
@Table(name = "first_year_faculty")
public class FirstYearFaculty {
	@Id
	...
	public FirstYearFaculty() {
		
	}

	public FirstYearFaculty(String regId) {
		this.regId = regId;
	}
	...
	public String toString() {
		return "FirstYearFaculty [regId=" + regId + ", firstName=" + firstName + ", average=" + average + ", cse=" + cse
				+ ", ece=" + ece + ", hAndS=" + hAndS + ", civil=" + civil + ", eee=" + eee + ", mechanical="
				+ mechanical + "]";
	}
